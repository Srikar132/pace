...
- `lib/services/blocks_native_service.dart` is stale/incomplete. Use `app_limit_native_service.dart` + the `lockin/app_limits` channel as the real source of truth instead.
